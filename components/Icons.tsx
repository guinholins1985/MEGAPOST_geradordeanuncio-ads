...
export const MetaIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c2.25 0 4.33-.74 6-2.02.81-.62 1.5-1.34 2.02-2.14.33-.5.6-1.02.8-1.57.26-.69.4-1.42.4-2.17C22 6.48 17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-2.5-6.5h-2v-4h2v4zm5 0h-2v-4h2v4z" fill="url(#meta-gradient)" />
        <defs>
            <linearGradient id="meta-gradient" x1="2" y1="12" x2="22" y2="12" gradientUnits="userSpaceOnUse">
                <stop stopColor="#f9ce34" />
                <stop offset=".25" stopColor="#ee2a7b" />
                <stop offset=".5" stopColor="#6228d7" />
                <stop offset="1" stopColor="#0077f2" />
            </linearGradient>
        </defs>
    </svg>
);
